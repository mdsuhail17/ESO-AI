        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              Transform your learning experience with AI-powered textbook assistance. Get instant answers, 
              simple explanations, and prepare study materials effortlessly.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Explanations</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">Save</div>
